<h1>WPSSO Mobile App Meta Tags</h1>
...
<p>Adds a Mobile App Meta Tags settings page to the SSO menu with additional options:</p>
...
<p>Includes and optional Mobile Apps tab in the Document SSO metabox with additional options:</p>
