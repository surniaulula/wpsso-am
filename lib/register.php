...
if ( ! class_exists( 'WpssoAmRegister' ) ) {

	class WpssoAmRegister {
		...
		public function __construct() {
			...
			//register_uninstall_hook( WPSSOAM_FILEPATH, array( __CLASS__, 'network_uninstall' ) );
		...
		private function activate_plugin() {
			...
			$lca = 'wpssoam';
			$version = WpssoAmConfig::$cf['plugin'][$lca]['version'];	// only our config
