...
<span style="color:#33cc33">&#x0229b;</span> &nbsp; The WPSSO Mobile App Meta (aka WPSSO AM) Free extension works with either the Free or Pro version of WPSSO Core (Main Plugin).
...
**Version 1.8.0-dev.3 (2018/02/20)**
...
(2018/02/20) Refactored the WpssoAm min_version_notice() method to use PHP's trigger_error() and include a notice to refresh plugin update information.
